...
def check_voting_eligibility():
    ...
    try:
        ...
        print(f"'{age_input}' is not a valid age.")
        return
    ...
    if age >= VOTING_AGE:
        ...
        print(f"At {age} years old, you are not eligible to vote.")
...
def weather_advice():
    ...
    is_cold = True if cold_input == "yes" else False
    is_raining = True if raining_input == "yes" else False
...
def determine_season():
    ...
    try:
        ...
        print(f"'{day_input}' is not a valid day.")
        return
    ...
    if month_lower in ("jan", "feb"):
        ...
        season = "Winter" if day <= 19 else "Spring"
    elif month_lower in ("apr", "may"):
        season = "Spring"
    elif month_lower == "jun":
        season = "Spring" if day <= 20 else "Summer"
    elif month_lower in ("jul", "aug"):
        season = "Summer"
    elif month_lower == "sep":
        season = "Summer" if day <= 21 else "Fall"
    elif month_lower in ("oct", "nov"):
        season = "Fall"
